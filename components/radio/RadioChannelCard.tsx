    ...
    >
      ...
      <div className="relative bg-gradient-to-br from-[#1a1a1a]/90 to-[#0a0a0a]/90 backdrop-blur-xl border border-white/5 rounded-2xl md:rounded-3xl p-6 md:p-8 transition-all duration-700">
        ...
        <div
          ...
          style={{
            background: `radial-gradient(circle at 30% 20%, #39c5bb15, transparent 50%),
                         radial-gradient(circle at 70% 80%, #39c5bb10, transparent 50%)`,
          }}
          aria-hidden="true"
        />
        ...
        <div className="relative mb-6 flex items-center justify-center">
          ...
          <div
            ...
            style={{
              background: `linear-gradient(135deg, #39c5bb25, #39c5bb15)`,
              boxShadow: `0 0 40px #39c5bb20, inset 0 0 20px #39c5bb10`,
            }}
          >
        ...
        <button
          ...
          style={{
            background: isLoading
              ? `linear-gradient(135deg, #39c5bb60, #39c5bb40)`
              : `linear-gradient(135deg, #39c5bb, #39c5bbdd)`,
            boxShadow: isHovered && !isLoading
              ? `0 8px 32px #39c5bb40, 0 0 0 1px #39c5bb30`
              : `0 4px 16px #39c5bb20`,
          }}
        >
          {/* Button shine effect */}
          <div
            ...
            style={{
              background: `linear-gradient(90deg, transparent, #39c5bb40, transparent)`,
      ...
      <div
        ...
        style={{
          background: `linear-gradient(135deg, #39c5bb20, transparent)`,
        }}
        aria-hidden="true"
      />
    </article>
